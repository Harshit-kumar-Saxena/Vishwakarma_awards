...
def generate_launch_description():
    ...
    # 1. SETUP PATHS
    pkg_gazebo = FindPackageShare(package='bot_gazebo').find('bot_gazebo')
    pkg_description = FindPackageShare(package='bot_description').find('bot_description')
    pkg_ros_ign_gazebo = FindPackageShare(package='ros_ign_gazebo').find('ros_ign_gazebo')
    pkg_bot_control = FindPackageShare('bot_control')
    ...
    bridge_config_path = os.path.join(pkg_gazebo, 'config', 'bot_bridge.yaml')
