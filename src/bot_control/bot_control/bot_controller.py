...
class botController(Node):
    """
    Robust MoveIt / controller wrapper for bot arm.
    """
    ...
    def __init__(self):
        ...
        self.trajectory_client = ActionClient(
            self, FollowJointTrajectory, '/bot_arm_controller/follow_joint_trajectory'
        )
        ...
        self.get_logger().info('bot Controller initialized (Passive Mode)')
